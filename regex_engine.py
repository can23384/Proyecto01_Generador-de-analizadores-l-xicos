...
def main():
    ...
    print('Soporta símbolos escapados con \\ y epsilon ε')
    print('Ejemplos válidos:')
    print('  a(b|c)*')
    print('  (ab)+c')
    print('  a?bc')
    print('  a\\.b      (punto literal)')
    print('  a\\|b      (barra vertical literal)')
    print('  a|ε')
    print()
    ...
    while True:
        try:
            ...
            print(result['regex_with_concat'])

            print('\nExpresión aumentada:')
            print(result['augmented_regex'])

            print('\nPostfix:')
            print(postfix_to_string(result['postfix']))
            ...
            while True:
                cadena = input("\nIngrese una cadena para validar con el AFD minimizado (o 'nueva' para otra regex): ")
                if cadena.strip().lower() == 'nueva':
                    print()
                    break
